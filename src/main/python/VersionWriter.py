...
def main():
    ...
    with open(version_properties_filename, "w") as f:
        ...
        f.write("#\n")
        f.write("###################################################\n")
        f.write("%s=%s\n" % (mod_id + ".version", "%s.%s.%s" % (major, minor, build)))
        ...
        f.write("\n")
        f.write("%s=%s\n" % (mod_id + ".minecraft.version.client", mcversion))
        f.write("%s=%s\n" % (mod_id + ".minecraft.version.server", mcserverversion))
        f.write("%s=%s\n" % (mod_id + ".mcp.version", mcpversion))
        f.write("%s=%s\n" % (mod_id + ".fml.build.number", fml_build_number))
